...
$('#toggleTheme').on('click', function () {
  ...
  this.textContent = nuevoModo === 'dark' ? 'Modo Claro 🌞' : 'Modo Oscuro 🌙';

  $(this)
    .removeClass(isDark ? 'btn-outline-light' : 'btn-outline-dark')
    .addClass(isDark ? 'btn-outline-dark' : 'btn-outline-light');
});
